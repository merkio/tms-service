...
public class TestResult implements Serializable, Nameable, Parameterizable, Statusable, Timeable {
    ...
    public static Comparator<io.qameta.allure.entity.TestResult> comparingByTime() {
        return comparingByTimeAsc().reversed();
    }

    public static Comparator<io.qameta.allure.entity.TestResult> comparingByTimeAsc() {
        return comparing(
            io.qameta.allure.entity.TestResult::getTime,
